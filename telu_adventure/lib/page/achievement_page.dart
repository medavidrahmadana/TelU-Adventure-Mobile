...
class achievement_page extends StatelessWidget {
  ...
  achievement_page({Key? key, required this.UID}) : super(key: key);
                    ...
                    children: [
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: GameXPBar(
                            maxWidth: 375.0,
                            value: 37.5, // Example XP value, this should be dynamic
                          ),
                        ),
                      ),
                      Positioned(
...
class ModulAch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: status == 'false' ? Colors.black.withOpacity(0.7) : Colors.white,
